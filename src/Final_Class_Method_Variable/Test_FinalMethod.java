...
public class Test_FinalMethod extends FinalMethod{
	...
	public static void main(String[] args) {// create object and reference of child class. 
		...
		Test_FinalMethod ob = new Test_FinalMethod();
		ob.test1();
		ob.test2();
		ob.test3();
		ob.test4();
		...
		FinalMethod ob2 = new Test_FinalMethod();
		ob2.test1();
		ob2.test3();
		ob2.test4();
		ob2.test5();
