...
public class TestExample4 extends Example4{
	...
	public void test1() {
	System.out.println("Child class Example4 having public method test1()");
	}

	protected void test2() {
	System.out.println("Child class Example4 having protected method test2()");
	}

	private void test3() {
	System.out.println("Child class Example4 having private method test3()");
	}

	void test4() {
	System.out.println("Child class Example4 having default method test4()");
	}

	public static void test5() {
	System.out.println("Child class Example4 having Static method test5()");
	}
